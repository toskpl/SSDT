...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [WWI_InMemory_Data_3376FE13], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_WWI_InMemory_Data_3376FE13.mdf') TO FILEGROUP [WWI_InMemory_Data];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [USERDATA_46DA1A9], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_USERDATA_46DA1A9.mdf') TO FILEGROUP [USERDATA];
